...
📦 安装包: dist/macos/FFmpeg-Binary-Installer.pkg
```

**用户安装体验 (像爱奇艺、网易云那样):**

1. 用户双击 `FFmpeg-Binary-Installer.pkg`
...
4. **服务自动在后台启动,没有任何黑色终端窗口**
5. 系统通知: "FFmpeg Binary 服务已安装并启动"
...
# 验证
open dist/macos/FFmpeg-Binary-Installer.pkg
